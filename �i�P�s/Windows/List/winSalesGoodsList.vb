Public Class winSalesGoodsList
    ...
    Private Sub winSalesGoodsList_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        access = Nothing
    End Sub
    ...
    Private Sub btRead_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btRead.Click
        ...
        If text <> "" AndAlso Not cbKeyWord.Items.Exists(Function(s As String) s = text) Then
            ...
            Loop
            'If cbKeyWord.Items.Count > 50 Then cbKeyWord.Items.RemoveRange(50, cbKeyWord.Items.Count - 50)
